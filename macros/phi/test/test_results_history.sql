    ...
    {% if target.name != 'default' %}
        ...
        {% for result in results if result.node.resource_type == 'test' and ('test_step_by_step' in result.node.raw_sql or 'test_time_travel' in result.node.raw_sql or 'test_step_by_step_wmt' in result.node.raw_sql) %}
            ...
            select 
                ...
                table_a_col_2_value::text as table_a_col_2_value,
                table_b_col_2_value::text as table_b_col_2_value,
                col_2_diff::text as col_2_diff,
                col_3_name::text as col_3_name,
                table_a_col_3_value::text as table_a_col_3_value,
                table_b_col_3_value::text as table_b_col_3_value,
