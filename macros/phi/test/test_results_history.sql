    ...
    {% if target.name != 'default' %}
        ...
        {% for result in results if result.node.resource_type == 'test' and ('test_step_by_step' in result.node.raw_sql or 'test_time_travel' in result.node.raw_sql) %}
            ...
            select 
                ...
                table_a_value_1::text as table_a_col_1_value,
                table_b_value_1::text as table_b_col_1_value,
                col_1_diff::text as col_1_diff,
                col_2_name::text as col_2_name,
                table_a_value_2::text as table_a_col_2_value,
                table_b_value_2::text as table_b_col_2_value,
                col_2_diff::text as col_2_diff,
                col_3_name::text as col_3_name,
                table_a_value_3::text as table_a_col_3_value,
                table_b_value_3::text as table_b_col_3_value,
